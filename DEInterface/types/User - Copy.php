...
class User implements ITypes
{
    ...
    public function convertToMongoFormat($userDetails, $oldData = [], $newData = [])
    {
        ...
        foreach ($userDetails as $key => $value) {
            switch ($key) {
                ...
                case 'class':
                case 'section':
                    if (($category = $oldData['category'] ?? false) && $category == 'STUDENT') {
    ...
    public function updateFromMysqlToMongo($mongoData, $mysqlData)
    {
        ...
        //echo "<pre>";print_r($mongoUpdatedData);die;
        ...
        echo "classUpgrade breakPoint inside convertToMongoFormat - User.php";//exit;
        ...
        //perform type check here and 
        
        //send request to API from here
        return $returnData;
    }
